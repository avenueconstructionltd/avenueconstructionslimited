      ...
      <main className="min-h-screen bg-canvas pt-32 pb-12 z-10 relative">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col gap-12">
          ...
          <div className="max-w-3xl flex flex-col gap-6">
            ...
            >
              To coordinate a viewing of our signature residences or schedule a private consultation at our Dubai studio, please submit an inquiry below or contact our atelier directly.
            </motion.p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start border-t border-black/5 pt-16">
            ...
            >
              <div>
                <h4 className="text-[10px] uppercase tracking-[0.2em] font-mono text-accent mb-3">Atelier Flagship</h4>
              ...
              <div>
                <h4 className="text-[10px] uppercase tracking-[0.2em] font-mono text-accent mb-3">Atelier Communications</h4>
                <p>General inquiries: inquire@js-estate.com</p>
                <p>Direct Advisory Line: +971 4 555 0199</p>
              </div>

              <div>
                <h4 className="text-[10px] uppercase tracking-[0.2em] font-mono text-accent mb-3">Consultation Hours</h4>
          ...
          <div className="relative overflow-hidden rounded-[2.5rem] bg-text-primary text-canvas px-8 md:px-16 py-16 md:py-20 grid grid-cols-1 md:grid-cols-3 gap-10 items-center">
            <div className="md:col-span-2 flex flex-col gap-5">
              ...
              <h2 className="font-serif text-3xl md:text-4xl uppercase tracking-tight leading-[1.05]">
                Private viewings by <span className="italic font-light text-accent">reservation only</span>
              </h2>
              <p className="text-sm text-canvas/70 leading-relaxed font-light max-w-[55ch]">
                Every inquiry is handled under strict confidentiality. Our advisory partners coordinate viewings, due diligence, and acquisitions with the discretion expected by family offices and institutional collectors.
              </p>
            </div>
            <div className="flex flex-col gap-4 md:items-end">
              <div className="flex flex-col gap-1 md:items-end">
                <span className="text-[9px] uppercase tracking-[0.22em] text-canvas/50">Direct Advisory</span>
                <span className="font-mono text-xl text-canvas">+971 4 555 0199</span>
              </div>
              <div className="flex flex-col gap-1 md:items-end">
                <span className="text-[9px] uppercase tracking-[0.22em] text-canvas/50">Atelier Email</span>
                <span className="font-mono text-sm text-canvas/90">inquire@js-estate.com</span>
              </div>
            </div>
          </div>
